...
\begin{figure}[htbp]
  \centering
  \includesvg[width=0.5\textwidth]{img/ParadigmsOverview.svg}
...
\end{subfigure}
\caption{Explication des ports et de la programmation multi-agent.}
\end{figure}
...
Si, à la place, on declare à nouveau \lstinline|X|, cette fois-ci,
on crée une nouvelle variable en mémoire, $x'$, qui sera initialisée à $999$.
